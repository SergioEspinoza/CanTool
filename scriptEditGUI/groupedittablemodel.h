...
public:
    ...
    static const int GROUP_EDIT_COL_COUNT = 17;
    // column contents
   ...
   // static const QString MSG_KEY_HEADER;
    ...
    // check box
    static const int MSG_TABLE_COL_CYCLE1 = 6;
    // text edit
    static const int MSG_TABLE_COL_CYCLE2 = 7;
    //slider
    //static const int MSG_TABLE_COL_CYCLE3 = 11;
    static const QString MSG_CYCLE_HEADER;

    // text edit
    static const int MSG_TABLE_COL_BURST = 8;
    static const QString MSG_BURST_HEADER;

    //check box
    static const int MSG_TABLE_COL_HIGHLOAD = 9;
    static const QString MSG_HILOAD_HEADER;


    //check box
    //static const int MSG_TABLE_COL_GTWY1 = 10;
    // combo box
    //static const int MSG_TABLE_COL_GTWY2 = 15;
    //static const QString MSG_GTWY_HEADER;

    //text edit
    static const int MSG_TABLE_COL_DATA0 = 10;
    static const QString MSG_DATA_HEADER0;

    //text edit
    static const int MSG_TABLE_COL_DATA1 = 11;
    static const QString MSG_DATA_HEADER1;

    //text edit
    static const int MSG_TABLE_COL_DATA2 = 12;
    static const QString MSG_DATA_HEADER2;
    //text edit
    static const int MSG_TABLE_COL_DATA3 = 13;
    static const QString MSG_DATA_HEADER3;

    //text edit
    static const int MSG_TABLE_COL_DATA4 = 14;
    static const QString MSG_DATA_HEADER4;
    //text edit
    static const int MSG_TABLE_COL_DATA5 = 15;
    static const QString MSG_DATA_HEADER5;

    //text edit
    static const int MSG_TABLE_COL_DATA6 = 16;
    static const QString MSG_DATA_HEADER6;

    //text edit
    static const int MSG_TABLE_COL_DATA7 = 17;
